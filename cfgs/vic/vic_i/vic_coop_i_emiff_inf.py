...
data_root = 'data/1020_vic_coop_i/'
class_names = ['Car']
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'vic_coop_i_1219_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'vic_coop_i_1219_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
...
run_name = '0205_vic_coop_i_imvoxelnet_inf_dcn_mean_12e_bs2x4'
wandb_init_dict = dict(
    type='WandbLoggerHook',
    init_kwargs = dict(
        project='VICFuser_Archive',
        name=run_name))
log_config = dict(
    interval=50,
...
evaluation = dict(interval=1, start=1, save_best='KITTI/Car_3D_AP40_easy_loose', rule='greater')
