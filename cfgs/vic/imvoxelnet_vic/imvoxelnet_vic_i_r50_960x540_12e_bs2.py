...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'dair_coop_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'dair_coop_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/1108_vic_i_re3_imvoxelnet_r50_960x540_12e_bs2x2'
gpu_ids = range(0, 1)
