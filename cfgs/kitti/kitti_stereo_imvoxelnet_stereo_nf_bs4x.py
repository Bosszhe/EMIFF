...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'kitti_stereo_rc4_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'kitti_stereo_rc4_infos_val.pkl',
        split='training',
        pts_prefix='velodyne_reduced',
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/1104_kitti_stereo_imvoxelnet_stereo_nf_bs4x2'
gpu_ids = range(0, 1)
