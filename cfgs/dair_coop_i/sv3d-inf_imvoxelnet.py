work_dir = './work_dirs/0114_ss3d_inf_imvoxelnet'

dataset_type = "KittiDataset"
# data_root = "../../../data/DAIR-V2X/single-infrastructure-side/"
data_root = "/home/wangz/wangzhe21/HBEVFuser/mmdet3d_v1_0_0rc4/mmdetection3d/data/0114_single_inf/"
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + "single_inf_0114_infos_train.pkl",
            split="training",
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + "single_inf_0114_infos_val.pkl",
        split="training",
        pts_prefix="velodyne_reduced",
