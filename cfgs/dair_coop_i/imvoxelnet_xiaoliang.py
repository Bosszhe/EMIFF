...
data_root = '/home/wangz/wangzhe21/HBEVFuser/mmdet3d_v1_0_0rc4/mmdetection3d/data/3_27_cooperative-infrastructure-side-lidar/'
class_names = ['Car']
...
lr_config = dict(policy='step', step=[8, 12, 22])
total_epochs = 12
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/0115_imvoxelnet_xiaoliang'
device = 'cuda'
gpu_ids = range(0, 1)
