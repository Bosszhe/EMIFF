...
class KittiDataset(Custom3DDataset):
    ...
    def __init__(self,
        ...
        # embed(header='KittiDataset.__init__')
    ...
    def get_data_info(self, index):
        ...
        """
        # from IPython import embed
        # embed(header='KittiDataset.get_data_info')
    ...
    def show(self, results, out_dir, show=True, pipeline=None):
        ...
        for i, result in enumerate(results):
            ...
            ids_veh = list(['003150','004105','010813','010948','010989','011530','011867','013848','019940','019947','019981'])
            if file_name in ids_veh:
                index = ids_veh.index(file_name)
                print(index)
                print('file_name:',file_name)
                file_name = ids_veh[index]
            else:
                continue
            print(file_name)

            # ids_inf = list(['011326','009362','016818','016953','016994','012695','014706','014943','004616','004623','004657'])
            # if file_name in ids_inf:
            #     index = ids_inf.index(file_name)
            #     print(index)
            #     print('file_name:',file_name)
            #     file_name = ids_veh[index]
            # else:
            ...
            ORF_pipeline = [dict(
                ...
                point_cloud_range=[5.0, -39.68, -3, 100.0, 39.68, 1])]
            
            ORF_pipeline = self._get_pipeline(ORF_pipeline)

            assert isinstance(ORF_pipeline.transforms[0],ObjectRangeFilter)

            anno = self.get_ann_info(i)
            anno_f = ORF_pipeline.transforms[0](anno)
            ...
            pred_f = ORF_pipeline.transforms[0](pred)
