...
from mmdet3d.models.fusion_layers.point_fusion import point_sample_vic
from mmdet.models.detectors import BaseDetector
from mmdet3d.models.builder import DETECTORS, build_backbone, build_head, build_neck


@DETECTORS.register_module()
class ImVoxelNet_VIC(BaseDetector):
    ...
    def extract_feat(self, img, img_metas):
        ...
        # embed(header='ImVoxelNet_VIC.extract_feat')
        ...
        for feature, img_meta in zip(x, img_metas):
            ...
            volume = point_sample_vic(
                img_meta,
                img_features=feature,
                points=points,
                proj_mats=img_meta['lidar2img'],
                coord_type='LIDAR',
    ...
    def forward_train(self, img, img_metas, gt_bboxes_3d, gt_labels_3d,
        ...
        """
        # from IPython import embed
        # embed(header='ImVoxelNet_VIC.forward_train')
    ...
    def forward_test(self, img, img_metas, **kwargs):
        ...
        # from IPython import embed
        # embed(header='ImVoxelNet_VIC.forward_test')
    ...
    def simple_test(self, img, img_metas):
        ...
        # from IPython import embed
        # embed(header='ImVoxelNet_VIC.simple_test')
        x = self.extract_feat(img, img_metas)
        x = self.bbox_head(x)
