...
from mmdet3d.models.fusion_layers.point_fusion import point_sample_s
from mmdet.models.detectors import BaseDetector
from mmdet3d.models.builder import DETECTORS, build_backbone, build_head, build_neck


@DETECTORS.register_module()
class ImVoxelNet_Stereo(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        print('ImVoxelNet_Stereo.__init__')
    ...
    def extract_feat(self, img, img_metas):
        ...
        # embed(header='ImVoxelNet_Stereo.extract_feat')
    ...
    def forward_train(self, img, img_metas, gt_bboxes_3d, gt_labels_3d,
        ...
        """
        # from IPython import embed
        # embed(header='ImVoxelNet_Stereo.forward_train')
