...
import math
from mmdet3d.models.detectors.vicfuser_voxel.vicfuser_voxel_msca_c_ccm import MultiScaleBlock
...
class VICFuser_Voxel_MSCA(BaseDetector):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 neck_dcn=None):
        print('VICFuser_Voxel_MSCA_0201.__init__')
