...
class Coord_transformation(object):
    ...
    def forward(self, from_coord, to_coord, path_all):
        coord_list = ["Infrastructure_lidar", "World", "Vehicle_lidar" , 'Infrastructure_lidar_nodelta']
        if (from_coord in coord_list) and (to_coord in coord_list):
            ...
            if from_coord == "Vehicle_lidar" and to_coord == "Infrastructure_lidar":
                ...
                return rotation, translation
            if from_coord == "World" and to_coord == "Infrastructure_lidar_nodelta":
                rotation, translation = self.Coord_World2infrastructure_lidar_nodelta(path_all)
                return rotation, translation
        else:
    ...
    def Coord_Infrastructure_lidar2world_nodelta(self, path_all):
    ...
    def Coord_World2infrastructure_lidar_nodelta(self, path_all):
        rotation, translation = self.Coord_Infrastructure_lidar2world_nodelta(path_all)
